...
public class PaymentDetails extends MotherPage {
    ...
    public void addPaymantDetails(){
        pressPaymentdDetailsButton();
        pressAdditionOfPaymentButton();
        pressTypeOfpaymentList();
        pressFeeForRegistrationActionsListItem();
        pressReasonRadioButton();
        pressReasonList();
        pressAtTheRequestOfTheNBUListItem();
        pressApplyButton();

        pressAdditionOfPaymentButton();
        pressTypeOfpaymentList();
        pressFeeForProvidingInformationListItem();
        pressReasonRadioButton();
        pressReasonList();
        pressAtTheRequestOfTheNBUListItem();
        pressApplyButton();
